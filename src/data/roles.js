export const roles = [
  {
    ...
    responsibilities: [
      'Led rides from 2 to 6 hours across desert and mountain terrain, beginner to advanced',
      'Managed 2–3 day overnight camping experiences with horses in Montaña de Oro State Park',
      'Ran full-day horsemanship clinics: ring instruction, trail rides, guest communication',
